...
export def "API ListTasks" []: record<profile: oneof<nothing, int>, > -> record<tasks: list<record<id: oneof<nothing, int>, name: oneof<nothing, string>, >>> {
    serialize .ListTasksRequest | req API ListTasks | deserialize .ListTasksResponse
}
...
export def "API ProgressUpdate" []: record<profile: oneof<nothing, int>, time: oneof<nothing, datetime>, updated_tasks: list<int>> -> record<id: oneof<nothing, int>, > {
